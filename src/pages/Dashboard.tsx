// ✅ src/pages/Dashboard.tsx — versión de bienvenida con fondo dinámico + logo + enlace a WAPP
...
export default function Dashboard() {
  // Determinar el fondo según el tamaño de pantalla
    ...
    <>
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center text-center px-4">
          ...
          {/* 🔹 Botón de acceso manual al dashboard */}
          <a
